...
export const messages: Record<string, string> = {
  ...
  'card.config.access.placeholder': 'Conversation access',
  'card.config.access.allowlist': '🔒 Allowlist and chat grants',
  'card.config.access.all': '🌐 All (everyone in app availability scope)',
